  ...
  return (
    <div style={{ width: '100%', height: '100vh' }}
      ...
      <div style={{ width: '600px' }} className='bg-light p-5 rounded'>
        <h3 style={{ height: '40px' }}>SIMPLE INTEREST CALCULATER</h3>
        <p>Calculate your simple interest Easily</p>

        <div style={{ width: '100%', height: '150px' }}
          className='d-flex justify-content-center align-items-center bg-warning mt-5 
          text-light shadow rounded flex-column'>
          <h1 style={{ height: '45px' }}> ₹ {interest}</h1>
        ...
        <form className='mt-5' onSubmit={handleCalculate}>
          <div className='mb-3'>
            ...
            <TextField className='w-100' id="outlined-basic-principle"
              label="₹ Principle Amount" variant="outlined" name='principle'
          ...
          <div className='mb-3'>
            <TextField className='w-100' id="outlined-basic-rate"
              label="Rate of Interest (%)" variant="outlined" name='rate' value={rate || ""} onChange={e => validateUserInput(e)} />
          </div>
          ...
          <div className='mb-3'>
            <TextField className='w-100' id="outlined-basic-principle" label="Time period (yr) "
              variant="outlined" name='year' value={year || ""} onChange={e => validateUserInput(e)} />
          </div>
